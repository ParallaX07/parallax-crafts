...
const Register = () => {
    useDocumentTitle("Register | ParallaX Crafts");
    ...
    return (
        <section className="min-h-dvh lg:w-full flex items-center justify-center mt-20 bg-[url('https://i.ibb.co/fC60nDV/985c482c-f97e-42e3-be75-378bafdc84aa-1.jpg')] bg-contain">
            <div className="bg-secondary animate__animated animate__fadeIn xl:mx-auto xl:min-w-fit custom-shadow p-4 xl:max-w-sm 2xl:max-w-md rounded-lg border-8 border-accent mx-3 mt-8">
