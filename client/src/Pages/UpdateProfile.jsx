...
const UpdateProfile = () => {
    ...
    return (
        <section className="lg:h-[calc(100dvh-100px)] bg-[url('https://i.ibb.co/zJj4SWJ/31ef315a-a5a1-4217-901d-6e8fd6d10f55-1.jpg')] bg-contain w-full flex items-center justify-center mt-20">
            <div className="glass animate__animated animate__fadeIn">
                <div className="flex lg:flex-row-reverse h-fit gap-4 flex-col rounded-2xl bg-secondary items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-8">
                    <div className=" flex flex-col m-2">
                        <div className="lg:min-w-72 mb-6 object-contain">
                            <img
